...
public class ChatPanel extends BackgroundPanel implements IChat {
	...
	private static final ImageIcon nullIcon = SkinUtils
			.getImageIcon("transparent");
	...
	ClearInputtingTask clearInputTask;
	ClearAlertTask clearAlertTask;
	CompressPicTask compressPicTask;
	...
	public void openFileChooser(ActionEvent e) {
		if (fileChooser == null) {
			fileChooser = new WebFileChooser(view, "Choose any files");
