...
public class RichTextPane extends WebTextPane {
	...
	public class LinkController extends MouseAdapter implements MouseMotionListener {
		...
		public void mouseClicked(MouseEvent e) {
			boolean isSupportedBrowse = false;
			java.awt.Desktop desktop = null;
			if(java.awt.Desktop.isDesktopSupported()) {
				desktop = java.awt.Desktop.getDesktop();
				if(desktop.isSupported( java.awt.Desktop.Action.BROWSE ) ) {
					isSupportedBrowse = true;
				} else {
					LOG.info("Desktop doesn't support the browse action (fatal)");
				}
	        } else {
	        	LOG.info("Desktop is not supported (fatal)");
	        }
